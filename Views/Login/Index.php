...
<body>
    <div class="background">
        ...
        <div class="conteiner">
            ...
            <img src="<?php echo media(); ?>/Imgs/inicio.png" alt="" id="imgss">
...
compartir y adquirir información a tu gusto</h5>
            ...
            <form action="" class="inicio_de_sesion" id="login">
            ...
            <form action="" class="inicio_de_sesion" id="registro">
                <input type="text" required class="email" name="nombre" placeholder="nombre">
                <input type="password" required class="password" name="password" placeholder="contraseña">
                <input type="email" required class="email" name="email" placeholder="correo">
                <input type="tel" required class="email" name="tel" placeholder="telefono">
